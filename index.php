...
<body>
    ...
    <div class="content">
            ...
            <div class="banner-wrapper">
                <div class="banner-content container">
                    <div class="banner-text">
                        ...
                        <h3>оптом по г.аЛМАТЫ и области</h3>
                        <button onclick="catalogBtn()">В Каталог</button>
                        <p><a><span></span>Только самые выгодные предложения</a><a><span></span>Бесплатная доставка по г.Алматы от 10 тыс ₸</a></p>
                    </div>
                </div>
            </div>
            <div class="blur"></div>
        ...
        <div class="products-container container">
            <h2><span>Акционные</span> товары</h2>
        ...
        <div class="map-wrapper container">
            <div class="map-content">
                <h2>Контакты</h2>
                <span>Оптовый поставщик «tmrln»</span>
                <p><i class='bx bx-map'></i><a><b>Адрес:</b>г.Алматы, ул. Тимирязева 17</a></p>
                <p><i class='bx bx-map'></i><a><b>Данные налогоплательщика:</b>ИП TemirlanA.B. ИИН: 040418500366</a></p>
            </div>
            <div class="blur"></div>
